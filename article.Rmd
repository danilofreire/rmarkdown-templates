...
author: "Danilo Freire^[PhD candidate, Department of Political Economy, King's College London. Email address: [danilofreire@gmail.com](mailto:danilofreire@gmail.com). I would like to thank ... for their helpful comments and suggestions. The usual disclaimer applies.  All data, code and information required to replicate this study are available at the following web address: <https://github.com/danilofreire/rmarkdown-article-template>.]"
...
\vspace{.5cm}
\noindent
\textsc{Keywords}: latex; rmarkdown; rstudio; template

\vspace{.5cm}
\noindent
\textsc{JEL Codes}: D710; K420; Z00
