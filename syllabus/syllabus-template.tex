...
E-mail: $if(email)$$email$$else$TBA$endif$ & Web: $if(web)$\href{http://$web$}{$web$}$else$TBA$endif$\\
Office Hours: $if(officehours)$$officehours$$else$TBA$endif$  &  Class Hours: $if(classhours)$$classhours$$else$TBA$endif$\\
Office: $if(office)$$office$$else$TBA$endif$  & Classroom: $if(classroom)$$classroom$$else$TBA$endif$\\
	&  \\
	\hline
	\end{tabular*}
